...
ALTER TABLE IF EXISTS contests DROP CONSTRAINT default_judge_fkey;
DROP TABLE IF EXISTS matches CASCADE;
ALTER TABLE IF EXISTS judges DROP CONSTRAINT judges_contest_id_fkey;
...
DROP FUNCTION IF EXISTS matches_start_time_check() CASCADE;
